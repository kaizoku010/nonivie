                   ...
                   <div className="kim-layout">
                    <div className="kim-left">
                       ...
                       <div className="vision-mission">
                        ...
                        <p className="">Our Vision is clear; to create a luxurious and transcendent experience that seemlessly blends opulence, culinary mastery, and vibrant nightlife.</p>

                   ...
                   <div className="kim-layout">
                    <div className="kim-left">
                       ...
                       <div className="vision-mission">
                        ...
                        <p className="vm-te">Our Mission is to be the ultimate destination for those who seek to indulge in exquisite flavors, immerse themselves in a dynamic nocturnal ambiance, and bask in the lap of luxury.</p>

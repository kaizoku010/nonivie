...
function MemberPage() {
  return (
    <div className="sasula">
            ...
            <p className='member-text'>Great! Here's some helpful information about credit card design 3D: Credit card design 3D refers to the process of creating three-dimensional models of credit cards using computer-aided design (CAD) software.</p>

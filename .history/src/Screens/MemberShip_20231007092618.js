...
import Nvlogo from "../imgs/rework/nv-slide.jpg"
...
<Carousel loop auto>
    ...
    <div className='slide-1'>
        ...
        <div className='slide-text'>
            <h1 className='slide-title'>Food, Recipes</h1>
            <h3 className='slide-des'>Mollit anim id est laborum. Sed ut perspiciatis unde omnis</h3>
            <p className='slider-para'>iste natus error sit voluptatem accusant tium doloremque laudan tiumotam</p>
            <button className='slide-button'>Book Now</button>
        </div>
      </div>

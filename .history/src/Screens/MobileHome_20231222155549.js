      ...
      <div className='mobile-container'>
        ...
        <div className='food-holder roundMe'>
         <div className='food-div'>
          <p>Born and raised in Uganda with a passion for the culinary arts, Chef Zein embarked on a
remarkable journey that has taken him to the pinnacle of the culinary world.</p>
         <img src={Food} className='zindex'/>
          <button style={{backgroundColor:"", marginTop:"5px"}} className='kim-btn'>Read More</button>
          </div> 
         </div>
        <ReserveSections />

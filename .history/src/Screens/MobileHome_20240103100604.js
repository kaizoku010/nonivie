...
import CarWash from "../imgs/carwash.jpg"
import NonivieButton from "../components/DxButton"
...
<ChristmasHero/>
      ...
      {/* <div className='ios-adoptive'> */}

        <div className='food-holder roundMe' id="ios-scroll">
        <h3 className='high-tec-text'>
        Step into the future of car care with our high-tech car wash – where precision, efficiency, and converge for an unparalleled cleaning experience.</h3>

         <div className='food-div'>
         {/* <img src={CarWash} className='zindex'/> */}        
          <NonivieButton link={"post/1"} text={"Read More"}/>

  ...
  return (
    ...
    {/* main content */}
     <div className='nvSection-main'>
        <img className='main-img' src={SideFlexx}/>
        ...
        <p style={{textAlign:"left", marginTop:"10px"}}>Crowd:</p>
...
<Link className='arrow-btn' to={`/section-page/${2}`}>Book Now</Link>
...
<div className='dx-image-sect'>

  <div style={{width:"300px", height:"200px"}} className='nvSection-para2'>
  </div>
  </div>
  <div className='nvSection-para' style={{}}>
    ...
    <Link to="/gallery"  className='nonivie-button'>Read More</Link>
...
<div className='call-to-action-content'>
  ...
  <p className='call-to-action-txt'>Our menu features a wide range of exquiste dishes made with culnary mastery.</p>
    ...
    <Link to="/menu" className='call-to-action-link'>Explore more{" >"}</Link>
</div>
</div>
{/* action holder 3 */}
<div className='call-to-action-holder'>
...
<div className='call-to-action-content'>
  ...
  <p className='call-to-action-txt'>Imagine yourself embarking on an unforgettable journey, exploring a new realm of luxury, book your opulent today!</p>
    ...
    <Link to="/reservations" className='call-to-action-link'>Book Now{" >"}</Link>
</div>
</div>

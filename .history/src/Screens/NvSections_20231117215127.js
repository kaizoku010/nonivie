...
<p style={{width:"300px", marginTop:"10px", marginBottom:}}>Immerse yourself in the sophisticated ambiance of Noni Vie. From the moment you enter, you'll be greeted by a fusion of contemporary design and exotic elements that create a truly enchanting atmosphere. </p>
<li>Chat met 1 van onze collega’s in de app.</li>
<li>Chat met 1 van onze collega’s in de app.</li>
 </ul>
 <button style={{color:"black"}} className='nonivie-button reColor'>Read More</button>
</div>

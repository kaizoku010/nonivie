        ...
        <div className='sect-page'>
            ...
            <div className='dx-breadcrumb'>
                <div className='dx-breadcrumber-content'>
                    <h1 style={{color:"white", marginTop:"20px"}}>Samen Unlimited</h1>
                    <h3 style={{color:"white", marginTop:"20px"}}>Nog een Unlimited abonnement voor maar € 20 per maand.</h3>
                    <h4 style={{color:"white", marginTop:"20px"}}>De vermelde prijs is i.c.m. een maandelijks opzegbaar Samen Unlimited Sim Only abonnement.</h4>
                </div>
            </div>

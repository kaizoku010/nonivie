...
import CC from "../imgs/cc_image.jpg";
...

    {
      ...
      btnColor:"white",
       ...
       amenities:["Breath taking view of the DJ's Floor", "Bottle Service", "Access To Ballerz End Is Exclusively After Placing A Reservation" ],
        ...
        excerpt: 'Savor the city skyline from the comfort of our plush velvet terrace, offering a breathtaking urban panorama. Be apart of a premium experience 🥂, & We are thrilled to announce that our exclusive spaces are filling up',
        content: "Indulge in a bottle of our finest champagne while reveling in the opulence of our champagne lounge.<br/><br/>Adorned with overhead screens, plush seating, and an ambiance that exudes sophistication, your experience promises to be truly exceptional."
    }
 ]
...
<MobileMenu/>
            ...
            <div style={{color:"white"}} className='dx-image'>
                   ...
                   */}
                  <SectionInfo data={sections_.amenities} image={sections_.mainImg} bookingData={sections_.id}/>
                  {/* {console.log("table type", sections_.tableTypes)} */}
                  {/* {console.log("Amenities ", sections_.amenities)} */}

<div style={{marginBottom:"30px"}}>
    <Link to="/bookings" className='nonivie-button'>Back to Sections</Link>
</div>
            </div>
            {/* call to action */}

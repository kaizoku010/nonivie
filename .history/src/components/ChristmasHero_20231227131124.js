...
function ChristmasHero() {
  return (
    <div className='christmas-banner'>
        ...
        <button className='nonivie-button colorMe'>Our Offers</button>
        </Link>
       <p className='our-chefs anime'>Our chef have crafted a special Christmas menu that blends traditional delights with a touch of contemporary flair.</p>     
    </div>
  )
}

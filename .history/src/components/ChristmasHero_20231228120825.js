...
function ChristmasHero() {
  return (
    <div className='christmas-banner'>
        ...
        <Link style={{alignSelf:"center", marginTop:"6px important"}} to="/menu">
        <button style={{marginTop:"6px important"}} className='nonivie-button colorMe anime'>Book Now</button>
        </Link>

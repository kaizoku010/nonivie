...
{/* slide one */}
  ...
  <img className='main-img-carousel2' src={FoodThree}/>
     ...
     <Lin to="/menu" rel='noopener noreferrer'><button  className='kim-btn' style={{marginTop:"50%", marginBottom:"50px", backgroundColor:"salmon", color:"black", fontWeight:"500"}} >Our Menu</button></Link>

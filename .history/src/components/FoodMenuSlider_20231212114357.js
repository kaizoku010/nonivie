...
{/* slide one */}
  ...
  <Link to="/menu" rel='noopener noreferrer'><button  className='kim-btn' style={{marginTop:"10%", marginBottom:"50px", backgroundColor:"salmon", color:"black", fontWeight:"500"}} >Our Menu</button></Link>  
  </div>

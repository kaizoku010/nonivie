...
{/* slide one */}
  ...
  <p className='carousle-food-subtitle about-text-mobile'>Savor the freshness of our high-quality ingredients and experience culinary excellence at its finest.</p>    
     </div>
     {/* slide two */}
     <div className='food-section'>

...
{/* slide one */}
  ...
  <Link to="/menu" className='' rel='noopener noreferrer'><button  className='kim-btn' style={{marginTop:"0%", marginBottom:"50px", backgroundColor:"salmon", color:"black", fontWeight:"500"}} >Our Menu</button></Link>  

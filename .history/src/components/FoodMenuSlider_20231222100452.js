...
{/* slide one */}
  ...
  <div className='food-l'>
  <Link to="/menu" className='food-link' rel='noopener noreferrer'><button  className='kim-btn' style={{marginTop:"0%", marginBottom:"50px", backgroundColor:"salmon", color:"black", fontWeight:"500"}} >Our Menu</button></Link>  
  </div>
     </div>
     {/* slide two */}
     <div className='food-section'>

...
{/* slide one */}
  ...
  <Link to="/menu" rel='noopener noreferrer'><button  className='food-btn' style={{marginTop:"0%", backgroundColor:"salmon", color:"black", fontWeight:"500"}} >Our Menu</button></Link>  
  </div>
     </div>
     {/* slide two */}
     <div className='food-section'>

...
import FooterIcon from "../imgs/1x/Asset 1footerIcon.png"
...
function MobileFooter() {
  return (
    ...
    <div className="mobile-footer-section-one">
        ...
        <p className="mobile-footer-content" style={{marginTop:"20px", display:"none !important"}}>At Noni Vie you are someone with impeccable
            taste and a knack for discovering the finest.
            We believe that true luxury isn't just about extravagance.<br/><br/> It's about creating remarkable

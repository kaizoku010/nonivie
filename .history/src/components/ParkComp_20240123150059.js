...
function ParkComp() {
    return (
        <div className='park-holder'>
            ...
            <h2>01</h2> <div><h3>Baller'z End</h3></div><img className='park-arrow' src={Arrow}/>
        </div>
                    ...
                    <div style={{ marginTop: "20px" }} className='park-section'>
                        <h2>04</h2> <h3>Valvet Terrace</h3> <img className='park-arrow' src={Arrow} />
                    </div>

                    <div style={{ marginTop: "20px" }} className='park-section'>
                        <h2>03</h2> <h3>Pantheon Sun Deck</h3> <img className='park-arrow' src={Arrow} />
                    </div>

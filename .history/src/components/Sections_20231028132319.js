                        ...
                        <div className='lower-level'>
                            ...
                            <div className='indoor-Section'>
                                ...
                                <div className='inner-sec'>
                                    ...
                                    <Link to="/bookings" state={"Champagne Club"}>
                                        <img style={{ marginBottom: "20px;", width:"100px" }} className='section' src={CallUsIC} />
                                        </Link>
                                        <img style={{ marginBottom: "40px" }} className='section' src={Book} />
                                        <p> Click the button below to have our reseervation team place a reseervation for you.</p>

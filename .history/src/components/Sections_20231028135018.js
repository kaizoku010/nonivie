                        ...
                        <div className='lower-level'>
                            ...
                            <div className='indoor-Section'>
                                ...
                                <div className='inner-sec'>
                                    ...
                                    <>
                                        <img style={{ marginBottom: "20px;", width:"100px" }} className='section' src={CallUsIC} />
                                        </>
                                        <img style={{ margin: "10px 0px" }} className='section small-ic' src={Book} />
                                        <p style={{width:"220px", margin:"20px"}}> Click the button below to have our reservation team place a reservation for you.</p>
                                        <button className='call-us-btn'>Reach Out</button>

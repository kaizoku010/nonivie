                ...
                <div className='middle-men'>
                    <div className='top-level'>
                        ...
                        <div className='lower-level'>
                            ...
                            <div className='indoor-Section'>
                                <img className='sec-title' src={CallUsText} />
                                <div  className='inner-sec'>
                                    ...
                                    <>
                                        ...
                                        <p style={{width:"220px", marginTop:"10px", marginBottom:"10px"}}> Click the button below to have our reservation team place a reservation for you.</p>

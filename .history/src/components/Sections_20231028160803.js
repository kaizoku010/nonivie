                            ...
                            <div className='indoor-Section'>
                                ...
                                <div  className='inner-sec'>
                                    ...
                                    <>
                                        ...
                                        <button onClick={handleCallClick} className='call-us-btn'>Call +256-774-088-577</button>
                            ...
                            <div className='indoor-Section'>
                                ...
                                <div  className='inner-sec'>
                                    ...
                                    <>
                                        ...
                                        <p style={{width:"220px", marginTop:"10px", marginBottom:"25px"}}> Click the button below to have our reservation team place a reservation for you.</p>
                                        <button onClick={handleCallClick} className='mobile-call-us-btn'>Call +256-774-088-577</button>

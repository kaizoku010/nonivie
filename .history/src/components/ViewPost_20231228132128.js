    ...
    return (
        <div className='single-post-page'>
            ...
            <div className='single-post-data'>
                ...
                <p>A Sanctuary Of Luxury
Nonivie is not just a place; but a sanctuary where luxury takes center stage.Our purpose is clear; to create a luxurious and transcendent experience that seemlessly blends opulence, culinary mastery, and vibrant nightlife.</p>
                </div>
            </div>

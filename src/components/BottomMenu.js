  ...
  return (
    <div className="menu-holder">
      <div className="menu-logo-pattern">
        ...
        <Link to="/menu" rel='noopener noreferrer' className="dom-links header-link">Food Menu</Link>
        ...
        <Link to="/blog"rel='noopener noreferrer' className="header-link">BLOG</Link>
